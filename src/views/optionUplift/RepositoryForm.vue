...
<script>
    ...
    import {getDropDownList, show} from '@api/optionUplift_api'
    ...
    export default {
        ...
        created() {
            this.changeLanguage()
            this.editSelectKey = Vue.ls.get('optionUplift_editSelectKey')
        ...
        watch: {
            ...
            '$route': {
                handler(route) {
                    if (route.name === 'optionUplift_edit') {
                        this.editSelectKey = Vue.ls.get('optionUplift_editSelectKey')
                        this.getDetailfun(this.editSelectKey)
                    }
                },
                ...
                show(rowKey).then(res => {
                    if (res.code != 0) {
                        ...
                        setTimeout(() => {
                            ...
                            this.$router.replace(`/optionUplift/optionUplift_list`);
                        }, 500);
                        return;
                    }

...
<script>
    ...
    import {getDropDownList, show} from '@api/groupCostForMT_api'
    ...
    created () {
        this.changeLanguage()
        this.editSelectKey = Vue.ls.get('groupCostForMT_editSelectKey')
    ...
    watch: {
        ...
        '$route': {
            handler (route) {
                ...
                if (route.name === 'groupCostForMT_edit') {
                    this.editSelectKey = Vue.ls.get('groupCostForMT_editSelectKey')
                    console.log(this.editSelectKey)
                    this.getDetailfun(this.editSelectKey)
                }
            ...
            show(rowKey)
                ...
                style: {'background': '#F5222D'}
                    ...
                    setTimeout(() => {
                        ...
                        this.$router.replace(`/groupCostForMT/groupCostForMT_list`);
                    }, 500);
                    return;
                }

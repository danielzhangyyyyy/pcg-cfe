<template>
  <a-card :bordered="false" class="content">
    ...
    <tableBtns
      ...
      uploadId="UPLOAD_DOMESTIC_FREIGHT_GL_FEE"
...
<script>
    ...
    import {del, getDropDownList, getGeoCode, list} from "@api/gLDomesticFRTFee_api";
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from "../../locales/zh-CN/gLDomesticFRTFee_lang.js";
    import langEn from "../../locales/en-US/gLDomesticFRTFee_lang.js";
  ...
  watch: {
    ...
    $route: {
      handler(route) {
        ...
        if (route.path === "/gLDomesticFRTFee/gLDomesticFRTFee_list") {
          this.handleOk();
        }
      },
      deep: true

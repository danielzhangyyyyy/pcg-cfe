...
<script>
    ...
    import {del, delAll, list} from "@api/wbFilterIn_api";
    import {exportByURL} from "@api/exportFunction_api";
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from "../../locales/zh-CN/wbFilterIn_lang.js";
    import langEn from "../../locales/en-US/wbFilterIn_lang.js";
  ...
  data() {
    return {
      ...
      exportLoading: false,
      uploadId:"UPLOAD_WBFILTER_IN_MODEL",
  ...
  watch: {
    ...
    $route: {
      handler(route) {
        ...
        if (route.path === "/wbFilterIn/wbFilterIn_list") {
          this.handleOk();
        }
      },
      deep: true
    ...
    returnBtnOnClick() {
      ...
      setTimeout(() => {
        ...
        this.$router.push({ path: "/writeBackFilter/writeBackFilter_list" });
      }, 500);
    },
    searchOnClick() {

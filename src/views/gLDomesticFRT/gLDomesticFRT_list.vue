<template>
    <a-card :bordered="false" class="content">
                ...
                <a-row :gutter="48">
                    ...
                    <a-col :md="!advanced && 8 || 24" :sm="24">
                        <span class="table-page-search-submitButtons" :style="advanced && { float: 'right', overflow: 'hidden' } || {} ">
                            <a-button type="primary" icon="search" :loading="searchLoading" @click="searchOnClick">{{ $t('lang.tabComSearchButtonName') }}</a-button>
                            <a-button style="margin-left: 8px" icon="undo" @click="resetSearchForm">{{ $t('lang.tabComResetButtonName') }}</a-button>
        ...
        <tableBtns
                ...
                exportId="UPLOAD_DOMESTIC_FREIGHT"
        >
            <a-button type="primary" @click="$router.replace('/gLDomesticFRTFee/gLDomesticFRTFee_list')">Upload Fee</a-button>
            <a-button type="primary" @click="$router.replace('/gLDomesticFRTRate/gLDomesticFRTRate_list')">Upload Rate</a-button>
        </tableBtns>
...
<script>
    ...
    import {getDropDownList, getGeoCode, list} from '@api/gLDomesticFRT_api'
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from '../../locales/zh-CN/gLDomesticFRT_lang.js'
    import langEn from '../../locales/en-US/gLDomesticFRT_lang.js'
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    if (route.path === '/gLDomesticFRT/gLDomesticFRT_list') {

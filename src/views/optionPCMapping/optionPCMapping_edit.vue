...
<script>
    import Vue from "vue";
    import {update} from "@api/optionPCMapping_api";
    ...
    validate() {
      ...
      const repositoryForm = new Promise((resolve, reject) => {
        repository.form.validateFields((err, values) => {
          ...
          if (values.childOption.trimEnd() == values.parentOption.trimEnd()) {
            this.$message.error("Child and Parent cannot be the same!");
            return;
          }
          resolve(values);
        });

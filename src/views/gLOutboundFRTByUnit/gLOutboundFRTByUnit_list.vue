<template>
  <a-card :bordered="false" class="content">
    ...
    >
      <a-button
        type="primary"
        @click="$router.replace(`/outboundFRTRate/outboundFRTRate_list`)"
      >Rate Upload</a-button>
      <a-button
        type="primary"
        @click="$router.replace(`/outboundFRTMot/outboundFRTMot_list`)"
      >MOT Upload</a-button>
      <a-button
        type="primary"
        @click="$router.replace(`/outboundFRTWeight/outboundFRTWeight_list`)"
      >Weight Upload</a-button>
    </tableBtns>
...
import {
  ...
  getGeoCode,
  list
} from "@api/gLOutboundFRTByUnit_api";

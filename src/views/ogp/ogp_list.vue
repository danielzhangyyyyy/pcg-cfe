...
<script>
    ...
    import {del, getDropDownList, list} from '@api/ogp_api'
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from '../../locales/zh-CN/ogp_lang.js'
    import langEn from '../../locales/en-US/ogp_lang.js'
        ...
        methods: {
            ...
            addNewTable() { // 新建列表
                if (this.queryParam.cycle != "CURRENT") {
                    ...
                    this.$router.replace('/ogp/ogp_add')
                }
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    if (this.queryParam.cycle != "CURRENT") {
                        ...
                        Vue.ls.set('ogp_editSelectKey', editSelectKey)
                        this.$router.replace(`/ogp/ogp_edit`)
                    }

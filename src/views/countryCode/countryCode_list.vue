...
<script>
    ...
    import {del, getDropDownList, list} from "@api/countryCode_api";
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from "../../locales/zh-CN/countryCode_lang.js";
    import langEn from "../../locales/en-US/countryCode_lang.js";
  ...
  watch: {
    ...
    $route: {
      handler(route) {
        ...
        if (route.path === "/countryCode/countryCode_list") {
          this.handleOk();
        }
      },
      deep: true
    ...
    addNewTable() {
      // 新建列表
      // this.$router.replace('/countryCode/countryCode_add')
    },
    editSelectOne() {
      // 修改选中行
      ...
      //     Vue.ls.set('countryCode_editSelectKey', editSelectKey)
      //     this.$router.replace(`/countryCode/countryCode_edit`)
    ...
    //     console.log(rowKey)
    //     Vue.ls.set('countryCode_dblclickRowKey', rowKey)
    //     this.$router.replace('/countryCode/countryCode_detail')

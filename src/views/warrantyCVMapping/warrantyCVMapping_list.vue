<template>
    <a-card :bordered="false" class="content">
        ...
        <tableBtns
                ...
                uploadId="UPLOAD_MTYPE_WARR_CV_MAP"
...
<script>
    ...
    import {del, getDropDownList, list} from '@api/warrantyCVMapping_api'
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from '../../locales/zh-CN/warrantyCVMapping_lang.js'
    import langEn from '../../locales/en-US/warrantyCVMapping_lang.js'
    ...
    export default {
        ...
        watch: {
            ...
            '$route': {
                handler(route) {
                    ...
                    if (route.path === '/warrantyCVMapping/warrantyCVMapping_list') {
                        this.handleOk()
                    }
                },
                deep: true
        ...
        methods: {
            ...
            addNewTable() { // 新建列表
                this.$router.replace('/warrantyCVMapping/warrantyCVMapping_add')
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    ...
                    Vue.ls.set('warrantyCVMapping_editSelectKey', editSelectKey)
                    this.$router.replace(`/warrantyCVMapping/warrantyCVMapping_edit`)
          ...
          style: { background: "#FAAD14" }
            ...
            //     console.log(rowKey)
            //     Vue.ls.set('warrantyCVMapping_dblclickRowKey', rowKey)
            //     this.$router.replace('/warrantyCVMapping/warrantyCVMapping_detail')

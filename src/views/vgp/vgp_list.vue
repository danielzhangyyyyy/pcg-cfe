...
<script>
    ...
    import {del, getDropDownList, list} from '@api/vgp_api'
        ...
        methods: {
            ...
            addNewTable() { // 新建列表
                if (this.queryParam.cycle != "CURRENT") {
                    ...
                    this.$router.replace('/vgp/vgp_add')
                }
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    if (this.queryParam.cycle != "CURRENT") {
                        ...
                        Vue.ls.set('vgp_editSelectKey', editSelectKey)
                        this.$router.replace(`/vgp/vgp_edit`)
                    }

<template>
    <a-card :bordered="false" class="content">
        ...
        <tableBtns
                ...
                uploadId="UPLOAD_DOMESTIC_FREIGHT_GL"
...
<script>
    ...
    import {del, getDropDownList, getGeoCode, list} from '@api/gLDomesticFRTRate_api'
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from '../../locales/zh-CN/gLDomesticFRTRate_lang.js'
    import langEn from '../../locales/en-US/gLDomesticFRTRate_lang.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                currentPageManipulationAuth: ["ViewEnforced", 'UploadEnforced', "DeleteEnforced"],
                searchLoading: false,
        ...
        watch: {
            ...
            '$route': {
                handler(route) {
                    ...
                    if (route.path === '/gLDomesticFRTRate/gLDomesticFRTRate_list') {
                        this.handleOk()
                    }
                },
                deep: true
        ...
        methods: {
            eventPush() {
                ...
                setTimeout(() => {
                    ...
                    this.$router.push({
                        path: "/gLDomesticFRT/gLDomesticFRT_list"
                    });
                }, 500);
            },

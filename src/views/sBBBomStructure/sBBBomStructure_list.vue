...
<script>
  ...
  methods: {
    ...
    getShows(value) {
      getShow({ item: value }).then(res => {
        // console.log('res:',res)
        this.description = `Product Description:${res.result.itemDesc} Cost Life:${res.result.eolStatus}`;
      });
    },

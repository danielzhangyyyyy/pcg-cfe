<template>
    <a-card :bordered="false" class="content">
        ...
        <tableBtns
                ...
                uploadId="UPLOAD_UI_COUNTRY_ADJ"
...
<script>
    ...
    import {list, del, getDropDownList} from "@api/countryAdjust_api";
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    ...
                    if (route.path === "/countryAdjust/countryAdjust_list") {
                        this.handleOk();
                    }
                },
                deep: true
        ...
        methods: {
            ...
            searchOnClick() {
                ...
                this.form.validateFields((err, values) => {
                    if (!err) {
                        ...
                        this.queryParam.modelNo = values.modelNo
                            ? "%" + values.modelNo.trim() + "%"
                            : values.modelNo;
            ...
            addNewTable() {
                // 新建列表
                this.$router.replace("/countryAdjust/countryAdjust_add");
            },
            editSelectOne() {
                // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    ...
                    Vue.ls.set("countryAdjust_editSelectKey", editSelectKey);
                    this.$router.replace(`/countryAdjust/countryAdjust_edit`);
            ...
            doubleClickOnRow(record) {
                ...
                console.log(rowKey);
                Vue.ls.set("countryAdjust_dblclickRowKey", rowKey);
                this.$router.replace("/countryAdjust/countryAdjust_detail");

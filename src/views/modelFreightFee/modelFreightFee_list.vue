<template>
    <a-card :bordered="false" class="content">
        ...
        <tableBtns
                ...
                uploadId="UPLOAD_MODEL_FREIGHT_FEE"
...
<script>
    ...
    import {del, getDropDownList, list} from '@api/modelFreightFee_api'
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from '../../locales/zh-CN/modelFreightFee_lang.js'
    import langEn from '../../locales/en-US/modelFreightFee_lang.js'
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    if (route.path === '/modelFreightFee/modelFreightFee_list') {
            ...
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    if (this.queryParam.cycle != "CURRENT") {
                        ...
                        Vue.ls.set('modelFreightFee_editSelectKey', editSelectKey)
                        this.$store.dispatch("ToggleCloseTab", "");
                        setTimeout(() => {
                            this.$store.dispatch(
                                "ToggleCloseTab",
                                "/modelFreightFee/modelFreightFee_edit" + this.lastQuery
                            );
                            ...
                            this.$router.replace({
                                path:`/modelFreightFee/modelFreightFee_edit`,
                                query: {
                        ...
                        // this.$router.replace(`/modelFreightFee/modelFreightFee_edit`)
                    }

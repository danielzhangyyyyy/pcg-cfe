...
<script>
    ...
    import {getDropDownList, show} from '@api/costTapeUpload_api'
    ...
    created () {
        this.changeLanguage()
        this.editSelectKey = Vue.ls.get('costTapeUpload_editSelectKey')
    ...
    watch: {
        ...
        '$route': {
            handler (route) {
                ...
                if (route.name === 'costTapeUpload_edit') {
                    this.editSelectKey = Vue.ls.get('costTapeUpload_editSelectKey')
                    console.log(this.editSelectKey)
                    this.getDetailfun(this.editSelectKey)
                }
            ...
            show(rowKey)
                ...
                style: {'background': '#F5222D'}
                    ...
                    setTimeout(() => {
                        ...
                        this.$router.replace(`/costTapeUpload/costTapeUpload_list`);
                    }, 500);
                    return;
                }

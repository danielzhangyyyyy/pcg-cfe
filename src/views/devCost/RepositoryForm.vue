...
<script>
    ...
    import {getDropDownList, show} from "@api/devCost_api";
  ...
  created() {
    this.changeLanguage();
    this.editSelectKey = Vue.ls.get("devCost_editSelectKey");
        ...
        .then(res => {
          if (res.code != 0) {
            ...
            setTimeout(() => {
              ...
              this.$router.replace(`/devCost/devCost_list`);
            }, 500);
            return;
          }

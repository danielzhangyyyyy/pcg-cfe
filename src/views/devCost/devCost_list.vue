...
<script>
    ...
    import {del, getDropDownList, list} from "@api/devCost_api";
    import {getXScrollSize} from "@api/publicFunc_api";
    import langZh from "../../locales/zh-CN/devCost_lang.js";
    import langEn from "../../locales/en-US/devCost_lang.js";
    ...
    export default {
        ...
        watch: {
            ...
            aspPrdFamilyDataList(val) {
                this.filterList.forEach(element => {
                    if (element["decorator"] == "aspPrdFamily") {
                        element["dropDownList"] = ['ALL'].concat(this.aspPrdFamilyDataList);
                    }
                });
            },
            language(val) {
            ...
            $route: {
                handler(route) {
                    ...
                    if (route.path === "/devCost/devCost_list") {
                        this.handleOk();
                    }
                },
                deep: true
        ...
        methods: {
            ...
            setDropDownLists() {
                ...
                this.filterList.forEach(element => {
                    if (element["decorator"] == "aspPrdFamily") {
                        element["dropDownList"] = [].concat(this.aspPrdFamilyDataList);
                    }
                });
            },
            ...
            addNewTable() {
                // 新建列表
                this.$router.replace("/devCost/devCost_add");
            },
            editSelectOne() {
                // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    ...
                    Vue.ls.set("devCost_editSelectKey", editSelectKey);
                    this.$router.replace(`/devCost/devCost_edit`);
            ...
            doubleClickOnRow(record) {
                ...
                console.log(rowKey);
                Vue.ls.set("devCost_dblclickRowKey", rowKey);
                this.$router.replace("/devCost/devCost_detail");

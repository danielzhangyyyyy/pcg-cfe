...
<script>
    ...
    import {getDropDownList, show} from '@api/cTOCVVKCost_api'
    ...
    created () {
        this.changeLanguage()
        this.editSelectKey = Vue.ls.get('cTOCVVKCost_editSelectKey')
    ...
    watch: {
        ...
        '$route': {
            handler (route) {
                ...
                if (route.name === 'cTOCVVKCost_edit') {
                    this.editSelectKey = Vue.ls.get('cTOCVVKCost_editSelectKey')
                    console.log(this.editSelectKey)
                    this.getDetailfun(this.editSelectKey)
                }
            ...
            show(rowKey)
                ...
                if (res.code != 0) {
                    ...
                    setTimeout(() => {
                        ...
                        this.$router.replace(`/cTOCVVKCost/cTOCVVKCost_list`);
                    }, 500);
                    return;
                }

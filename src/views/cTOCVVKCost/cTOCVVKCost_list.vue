            ...
            <a-form layout="inline" :form="form">
                <a-row :gutter="48">
                    ...
                    <template v-if="advanced">
                        ...
                        <a-col :md="8" :sm="24" v-for="item in filterList.slice(9,10)" :key="item.index">
                            <a-form-item :label="item.label">
                                <a-input
                                        :placeholder="item.placeHolder"
                                        v-if="item.inputType=='input'"
...
<script>
    ...
    import {del, getDropDownList, list} from "@api/cTOCVVKCost_api";
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from "../../locales/zh-CN/cTOCVVKCost_lang.js";
    import langEn from "../../locales/en-US/cTOCVVKCost_lang.js";
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    if (route.path === "/cTOCVVKCost/cTOCVVKCost_list") {
        ...
        methods: {
                ...
                this.form.validateFields((err, values) => {
                    ...
                    if (!err) {
                        for (let key in values) {
                            values[key] !== undefined && key !== "cycle"
            ...
            addNewTable() {
                ...
                if (this.queryParam.cycle === "CURRENT") {
                    this.$router.replace("/cTOCVVKCost/cTOCVVKCost_add");
                } else {
                    this.$notification.open({
                        message: "Warning:",
            ...
            editSelectOne() {
                ...
                if (selectedRowKeyslen == 1) {
                    ...
                    Vue.ls.set("cTOCVVKCost_editSelectKey", editSelectKey);
                    if (this.queryParam.cycle === "CURRENT") {
                        this.$router.replace(`/cTOCVVKCost/cTOCVVKCost_edit`);
                    } else {
                        this.$notification.open({
                            message: "Warning:",

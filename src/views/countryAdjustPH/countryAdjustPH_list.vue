<template>
    <a-card :bordered="false" class="content">
        ...
        <tableBtns
                ...
                uploadId="UPLOAD_UI_COUNTRY_ADJ_PH"
...
<script>
    ...
    import {del, getDropDownList, list} from '@api/countryAdjustPH_api'
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    if (route.path === '/countryAdjustPH/countryAdjustPH_list') {
        ...
        methods: {
            ...
            addNewTable() { // 新建列表
                if (this.queryParam.cycle != "CURRENT") {
                    ...
                    this.$router.replace('/countryAdjustPH/countryAdjustPH_add')
                }
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    if (this.queryParam.cycle != "CURRENT") {
                        ...
                        Vue.ls.set('countryAdjustPH_editSelectKey', editSelectKey)
                        this.$router.replace(`/countryAdjustPH/countryAdjustPH_edit`)
                    }

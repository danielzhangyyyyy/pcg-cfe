...
<script>
    ...
    import {del, getDropDownList, list} from "@api/basicNameEdit_api";
    import langZh from "../../locales/zh-CN/basicNameEdit_lang.js";
    import langEn from "../../locales/en-US/basicNameEdit_lang.js";
  ...
  watch: {
    ...
    $route: {
      handler(route) {
        ...
        if (route.path === "/sBBComponentFilter/BasicNameList") {
          this.handleOk();
        }
      },
      deep: true
  ...
  methods: {
    ...
    eventPush() {
      setTimeout(() => {
        ...
        this.$router.push({
          path: "/sBBComponentFilter/sBBComponentFilter_list"
        });
      }, 500);
    },
    searchOnClick() {
    ...
    addNewTable() {
      // 新建列表
      this.$router.replace("/basicNameEdit/basicNameEdit_add");
    },
    editSelectOne() {
      // 修改选中行
      ...
      if (selectedRowKeyslen == 1) {
        ...
        Vue.ls.set("basicNameEdit_editSelectKey", editSelectKey);
        this.$router.replace(`/basicNameEdit/basicNameEdit_edit`);
    ...
    doubleClickOnRow(record) {
      ...
      console.log(rowKey);
      Vue.ls.set("basicNameEdit_dblclickRowKey", rowKey);
      this.$router.replace("/basicNameEdit/basicNameEdit_detail");

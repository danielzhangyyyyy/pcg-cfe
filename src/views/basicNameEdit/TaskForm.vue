<template>
    <a-form @submit="handleSubmit" :form="form" class="form">
        <a-row class="form-row" :gutter="48">
            <a-col :lg="20" :md="24" :sm="24" v-for="(item,index) in babelList" :key="index">
                <a-form-item :label="item.label">
                    <a-row>
                      ...
                      pattern:new RegExp(/^[A-Z0-9_\s]*$/),
                      message:'Combine with capital letters, numbers, spaces, underscores'
                    }]}]"
                            />
                        </a-col>
                        <a-col :span="12">
                            <span style="color: red;">&nbsp;&nbsp;&nbsp;* Combine with capital letters, numbers, spaces, underscores</span>
                        </a-col>
                    </a-row>
                </a-form-item>
            </a-col>
...
<script>
    ...
    import Vue from "vue";
    import {getDropDownList} from "@api/basicNameEdit_api";

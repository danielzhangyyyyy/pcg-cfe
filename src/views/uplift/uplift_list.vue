...
<script>
    ...
    import {del, getDropDownList, list} from '@api/uplift_api'
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    if (route.path === '/uplift/uplift_list') {
        ...
        methods: {
            ...
            addNewTable() { // 新建列表
                if (this.queryParam.cycle != "CURRENT") {
                    ...
                    this.$router.replace('/uplift/uplift_add')
                }
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    if (this.queryParam.cycle != "CURRENT") {
                        ...
                        Vue.ls.set('uplift_editSelectKey', editSelectKey)
                        this.$router.replace(`/uplift/uplift_edit`)
                    }

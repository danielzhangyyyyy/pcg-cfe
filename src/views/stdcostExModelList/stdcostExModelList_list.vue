...
<script>
    ...
    import {del, delAll, list} from "@api/stdcostExModelList_api";
    import {exportByURL} from "@api/exportFunction_api";
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from "../../locales/zh-CN/stdcostExModelList_lang.js";
    import langEn from "../../locales/en-US/stdcostExModelList_lang.js";
  ...
  data() {
    return {
      ...
      exportLoading: false,
      uploadId:"UPLOAD_STDCOST_EX_MODEL",
  ...
  watch: {
    ...
    $route: {
      handler(route) {
        ...
        if (route.path === "/stdcostExModelList/stdcostExModelList_list") {
          this.handleOk();
        }
      },
      deep: true

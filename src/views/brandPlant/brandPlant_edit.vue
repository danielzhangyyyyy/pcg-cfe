...
<script>
    import Vue from "vue";
    import {update} from "@api/brandPlant_api";
  ...
  created() {
    this.editSelectKey = Vue.ls.get("brandPlant_editSelectKey");
          ...
          .then(res => {
            if (res.code == 0) {
              ...
              setTimeout(() => {
                ...
                this.$router.replace(`/brandPlant/brandPlant_list`);
              }, 500);
            } else {
                 this.$notification.open({
                message: "Error",

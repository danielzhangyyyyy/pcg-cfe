<template>
    <a-card :bordered="false" class="content">
        ...
        <a-table
                ...
                :dataSource="loadData">
            <div slot="status" slot-scope="text, record" :class="{redBGC: record.status=='ACTIVE' && record.failed, greenBGC: record.status=='ACTIVE' && !record.failed}">
                {{text}}
            </div>
            <a slot="instanceId" slot-scope="instanceId" @click="eventPush(instanceId)" href="javascript:;">
                {{instanceId}}
            </a>
        </a-table>
    </a-card>

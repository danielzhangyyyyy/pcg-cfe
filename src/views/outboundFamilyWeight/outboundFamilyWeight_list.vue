<template>
  <a-card :bordered="false" class="content">
    <tableBtns
      ...
      uploadId="UPLOAD_OUTBOUND_FREIGHT_GL_FAMILY_WEIGHT"
      @deleteSeclectAll="deleteSeclectAll"
    >
      <a-button icon="delete" type="primary" @click="deleteSeclectAlls">Remove All</a-button>
      <a-button
        type="primary"
        icon="search"
...
import {
  ...
  getDropDownList,
  list
} from "@api/outboundFamilyWeight_api";
import { getXScrollSize } from "@api/publicFunc_api";
import langZh from "../../locales/zh-CN/outboundFamilyWeight_lang.js";
import langEn from "../../locales/en-US/outboundFamilyWeight_lang.js";
  ...
  watch: {
    ...
    $route: {
      handler(route) {
        ...
        if (route.path === "/outboundFamilyWeight/outboundFamilyWeight_list") {
          this.handleOk();
        }
      },
      deep: true

...
<script>
    ...
    import {del, getDropDownList, list} from '@api/outboundItem_api'
    import { getXScrollSize } from "@api/publicFunc_api";
    import langZh from '../../locales/zh-CN/outboundItem_lang.js'
    import langEn from '../../locales/en-US/outboundItem_lang.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                currentPageManipulationAuth: ["ViewEnforced", 'UploadEnforced', "DeleteEnforced", "AddEnforced", "UpdateEnforced"],
                searchLoading: false,
        ...
        watch: {
            ...
            '$route': {
                handler(route) {
                    ...
                    if (route.path === '/outboundItem/outboundItem_list') {
                        this.handleOk()
                    }
                },
                deep: true
        ...
        methods: {
                ...
                this.form.validateFields((err, values) => {
                    ...
                    if (!err) {
                        for(let key in values){
                            values[key] !== undefined ? this.queryParam[key] = values[key].trim(): ''
                        }
            ...
            addNewTable() { // 新建列表
                this.$router.replace('/outboundItem/outboundItem_add')
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    ...
                    Vue.ls.set('outboundItem_editSelectKey', editSelectKey)
                    this.$router.replace(`/outboundItem/outboundItem_edit`)

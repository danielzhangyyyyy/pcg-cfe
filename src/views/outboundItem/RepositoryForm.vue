...
<script>
    ...
    import {getDropDownList, show} from '@api/outboundItem_api'
    ...
    export default {
        ...
        created() {
            this.changeLanguage()
            this.editSelectKey = Vue.ls.get('outboundItem_editSelectKey')
        ...
        watch: {
            ...
            '$route': {
                handler(route) {
                    ...
                    if (route.name === 'outboundItem_edit') {
                        this.editSelectKey = Vue.ls.get('outboundItem_editSelectKey')
                        console.log(this.editSelectKey)
                        this.getDetailfun(this.editSelectKey)
                    }
                ...
                show(rowKey).then(res => {
                    if (res.code != 0) {
                        ...
                        setTimeout(() => {
                            ...
                            this.$router.replace(`/outboundItem/outboundItem_list`);
                        }, 500);
                        return;
                    }

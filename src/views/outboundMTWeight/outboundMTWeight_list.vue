<template>
  <a-card :bordered="false" class="content">
    <tableBtns
      ...
      uploadId="UPLOAD_OUTBOUND_FREIGHT_GL_MT_WEIGHT"
...
import {
  ...
  getDropDownList,
  list
} from "@api/outboundMTWeight_api";
import { getXScrollSize } from "@api/publicFunc_api";
import langZh from "../../locales/zh-CN/outboundMTWeight_lang.js";
import langEn from "../../locales/en-US/outboundMTWeight_lang.js";
  ...
  watch: {
    ...
    $route: {
      handler(route) {
        ...
        if (route.path === "/outboundMTWeight/outboundMTWeight_list") {
          this.handleOk();
        }
      },
      deep: true

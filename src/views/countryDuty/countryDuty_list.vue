...
<script>
    ...
    import {del, getDropDownList, list} from '@api/countryDuty_api'
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    if (route.path === '/countryDuty/countryDuty_list') {
        ...
        methods: {
            ...
            addNewTable() { // 新建列表
                if (this.queryParam.cycle != "CURRENT") {
                    ...
                    this.$router.replace('/countryDuty/countryDuty_add')
                }
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    if (this.queryParam.cycle != "CURRENT") {
                        ...
                        Vue.ls.set('countryDuty_editSelectKey', editSelectKey)
                        this.$router.replace(`/countryDuty/countryDuty_edit`)
                    }

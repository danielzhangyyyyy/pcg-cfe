<template>
  <a-card :bordered="false" class="content">
    ...
    <!--<div class="table-operator">-->
      ...
      <!--&lt;!&ndash;<a-button type="primary" icon="plus-circle" @click="modelListOnClick">Model List</a-button>&ndash;&gt;-->
      <!--&lt;!&ndash;<a-button type="primary" icon="form" @click="executeModelListOnClick">Execute Model List</a-button>&ndash;&gt;-->
    <!--</div>-->
      ...
      <template slot="message">
        <div style="margin-right: 12px">
          ...
          <span v-else>
            ...
            {{title.brand}}&nbsp;&nbsp;
            <span :style="{'font-weight': 'bold'}">Product Family: &nbsp;</span>
            {{title.family}}&nbsp;&nbsp;
...
export default {
  ...
  watch: {
    ...
    // $route: {
    //     handler(route) {
    //         if (route.path === "/l1CostBom/l1CostBom_list") {
    //             this.loadData({});
    //         }
    //     },
    //     deep: true
  ...
  methods: {
    ...
    subPartOnClick(record) {
      ...
      setTimeout(() => {
        this.$store.dispatch(
          "ToggleCloseTab",
          "/l1CostBom/l1CostBom_detail" + this.lastQuery
        );
        ...
        this.$router.replace({
          path: "/l1CostBom/l1CostBom_detail",
          query: {
            cycle: record.cycle,

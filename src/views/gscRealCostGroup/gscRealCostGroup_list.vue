<template>
    <a-card :bordered="false" class="content">
        ...
        <tableBtns
                ...
                uploadId="UPLOAD_UI_GSC_REAL_COST_GROUP"
...
<script>
    ...
    import {del, getDropDownList, list} from '@api/gscRealCostGroup_api'
    ...
    export default {
        ...
        watch: {
            ...
            $route: {
                handler(route) {
                    if (route.path === '/gscRealCostGroup/gscRealCostGroup_list') {
        ...
        methods: {
            ...
            addNewTable() { // 新建列表
                if (this.queryParam.cycle != "CURRENT") {
                    ...
                    this.$router.replace('/gscRealCostGroup/gscRealCostGroup_add')
                }
            },
            editSelectOne() { // 修改选中行
                ...
                if (selectedRowKeyslen == 1) {
                    if (this.queryParam.cycle != "CURRENT") {
                        ...
                        Vue.ls.set('gscRealCostGroup_editSelectKey', editSelectKey)
                        this.$router.replace(`/gscRealCostGroup/gscRealCostGroup_edit`)
                    }

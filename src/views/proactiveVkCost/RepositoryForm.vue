...
import { show, getDropDownList } from '@api/proactiveVkCost_api'
...
export default {
    ...
    created () {
        this.changeLanguage()
        this.editSelectKey = Vue.ls.get('proactiveVkCost_editSelectKey')
    ...
    watch: {
        ...
        '$route': {
            handler (route) {
                ...
                if (route.name === 'proactiveVkCost_edit') {
                    this.editSelectKey = Vue.ls.get('proactiveVkCost_editSelectKey')
                    console.log(this.editSelectKey)
                    this.getDetailfun(this.editSelectKey)
                }
            ...
            show(rowKey)
                ...
                if (res.code != 0) {
                    ...
                    setTimeout(() => {
                        ...
                        this.$router.replace(`/proactiveVkCost/proactiveVkCost_list`);
                    }, 500);
                    return;
                }

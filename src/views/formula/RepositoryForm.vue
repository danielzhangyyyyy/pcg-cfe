...
<script>
    ...
    import {show} from "@api/formula_api";
  ...
  created() {
    this.changeLanguage();
    this.editSelectKey = Vue.ls.get("formula_editSelectKey");
  ...
  watch: {
        ...
        .then(res => {
          if (res.code != 0) {
            ...
            setTimeout(() => {
              ...
              this.$router.replace(`/formula/formula_list`);
            }, 500);
            return;
          }
          console.log(res);
    ...
    changeLanguage() {
      ...
      if (this.language == "zh-CN") {
        ...
        this.babelList = langEn.newEdit_langEn;
      }
      if (this.funSwitch) {
        // 首次不执行
        this.getDetailfun(this.editSelectKey);
